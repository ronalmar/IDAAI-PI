USE [master]
GO
/****** Object:  Database [IDAAI]    Script Date: 29/01/2023 23:29:01 ******/
...
( NAME = N'IDAAI', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\IDAAI.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'IDAAI_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\IDAAI_log.ldf' , SIZE = 139264KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [IDAAI]
GO
/****** Object:  User [idaaiuser]    Script Date: 29/01/2023 23:29:01 ******/
...
GO
/****** Object:  Table [dbo].[Carreras]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoAsistencia]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoDevolucion]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoItem]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Estudiantes]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inventario]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Items]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Modulos]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RegistroAsistencia]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RegistroPrestamoItem]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UsuarioModulo]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuarios]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Carreras]  WITH CHECK ADD  CONSTRAINT [FK__Carreras__Usuari__4E1E9780] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[Carreras] CHECK CONSTRAINT [FK__Carreras__Usuari__4E1E9780]
GO
ALTER TABLE [dbo].[Estudiantes]  WITH CHECK ADD  CONSTRAINT [FK__Estudiant__Usuar__725BF7F6] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[Estudiantes] CHECK CONSTRAINT [FK__Estudiant__Usuar__725BF7F6]
GO
ALTER TABLE [dbo].[Inventario]  WITH CHECK ADD  CONSTRAINT [FK__Inventari__Usuar__3EDC53F0] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[Inventario] CHECK CONSTRAINT [FK__Inventari__Usuar__3EDC53F0]
GO
...
GO
ALTER TABLE [dbo].[Items]  WITH CHECK ADD  CONSTRAINT [FK__Items__UsuarioId__56B3DD81] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[Items] CHECK CONSTRAINT [FK__Items__UsuarioId__56B3DD81]
GO
ALTER TABLE [dbo].[Modulos]  WITH CHECK ADD  CONSTRAINT [FK__Modulos__Usuario__2CBDA3B5] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[Modulos] CHECK CONSTRAINT [FK__Modulos__Usuario__2CBDA3B5]
GO
...
GO
ALTER TABLE [dbo].[RegistroAsistencia]  WITH CHECK ADD  CONSTRAINT [FK__RegistroA__Usuar__7167D3BD] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[RegistroAsistencia] CHECK CONSTRAINT [FK__RegistroA__Usuar__7167D3BD]
GO
...
GO
ALTER TABLE [dbo].[RegistroPrestamoItem]  WITH CHECK ADD  CONSTRAINT [FK__RegistroP__Usuar__6319B466] FOREIGN KEY([UsuarioId])
REFERENCES [dbo].[Usuarios] ([Id])
GO
ALTER TABLE [dbo].[RegistroPrestamoItem] CHECK CONSTRAINT [FK__RegistroP__Usuar__6319B466]
GO
...
GO
ALTER TABLE [dbo].[Usuarios]  WITH CHECK ADD  CONSTRAINT [FK__Usuarios__Modulo__477199F1] FOREIGN KEY([ModuloActualId])
REFERENCES [dbo].[Modulos] ([Id])
GO
ALTER TABLE [dbo].[Usuarios] CHECK CONSTRAINT [FK__Usuarios__Modulo__477199F1]
GO
/****** Object:  StoredProcedure [dbo].[sp_carrera]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_estudiante]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_inventario]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_item]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_modulo]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_prestamoitem]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_registroasistencia]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_usuario]    Script Date: 29/01/2023 23:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
