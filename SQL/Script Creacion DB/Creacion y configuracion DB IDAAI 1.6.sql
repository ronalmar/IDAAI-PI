USE [master]
GO
/****** Object:  Database [IDAAI]    Script Date: 22/12/2022 21:25:08 ******/
...
USE [IDAAI]
GO
/****** Object:  User [idaaiuser]    Script Date: 22/12/2022 21:25:08 ******/
...
GO
/****** Object:  Table [dbo].[Carreras]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoAsistencia]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoDevolucion]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EstadoItem]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Estudiantes]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inventario]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Items]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Modulos]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RegistroAsistencia]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RegistroPrestamoItem]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UsuarioModulo]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuarios]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_carrera]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_estudiante]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_inventario]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			INSERT INTO @Inventario(Id) VALUES(0)
		...
		(
			Nombre, Descripcion, CantidadTotal, Estado
		)
		SELECT	
			@nombre, @descripcion, @i_cantidadTotal, 1
	...
	BEGIN
		...
		IF ((ISNULL(@nombre,'')!='')AND(EXISTS(SELECT 1 FROM Inventario WHERE Nombre=@nombre AND Estado=1)))
		BEGIN
			INSERT INTO @Inventario(Id) VALUES(-1)
			SELECT TOP(1) * FROM @Inventario
			RETURN 0;
		END
		...
		UPDATE Inventario SET
		Nombre=ISNULL(@nombre, Inventario.Nombre),
		Descripcion=ISNULL(@descripcion, Inventario.Descripcion),
		CantidadDisponible=ISNULL(@i_cantidadDisponible, Inventario.CantidadDisponible),
		CantidadTotal=ISNULL(@i_cantidadTotal, Inventario.CantidadTotal)
		WHERE Id=@i_id
	...
	BEGIN
		...
		INSERT INTO @Inventario(Id, Nombre) VALUES(0, 'OK')
		SELECT TOP(1) * FROM @Inventario
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_item]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	BEGIN
		...
		IF ((ISNULL(@i_rfid,'')!='')AND(EXISTS(SELECT 1 FROM Items WHERE Rfid=@i_rfid AND Estado=1)))
		BEGIN
		...
		UPDATE Items SET
		Rfid=ISNULL(@i_rfid, Items.Rfid),
		EstadoItemId=ISNULL(@i_estadoItemId, Items.EstadoItemId),
		InventarioId=ISNULL(@inventarioIdInsertar, Items.InventarioId)
		WHERE Id=@i_id
	...
	BEGIN
		...
		IF NOT EXISTS(SELECT 1 FROM Items WHERE Id=@i_id AND Estado=1)
		BEGIN
			INSERT INTO @Item(Id, Rfid) VALUES(-1, 'NO EXISTE UN ITEM CON EL ID INGRESADO')
			SELECT TOP(1) * FROM @Item
			RETURN 0;
		END
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_modulo]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_prestamoitem]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	BEGIN		
		...
		BEGIN
			...
			BEGIN
				INSERT INTO @PrestamoItemClase(Id) VALUES(-3)
			...
			BEGIN
				...
				IF((SELECT DISTINCT COUNT(*) FROM @ItemsXML)!=(SELECT COUNT(*) FROM @ItemsXML))
				BEGIN
					INSERT INTO @PrestamoItemClase(Id) VALUES(-6)
					SELECT TOP(1) * FROM @PrestamoItemClase
					RETURN 0;
				END
				...
				BEGIN
					...
					BEGIN
						INSERT INTO @PrestamoItemClase(Id) VALUES(-7)
						SELECT TOP(1) * FROM @PrestamoItemClase
						RETURN 0;
					END
					...
					BEGIN
						INSERT INTO @PrestamoItemClase(Id) VALUES(-8)
						SELECT TOP(1) * FROM @PrestamoItemClase
						RETURN 0;
					END
			...
			BEGIN
				INSERT INTO @PrestamoItemClase(Id) VALUES(-4)
				SELECT TOP(1) * FROM @PrestamoItemClase
				RETURN 0;
			END
			...
			BEGIN
				INSERT INTO @PrestamoItemClase(Id) VALUES(-5)
				SELECT TOP(1) * FROM @PrestamoItemClase
				RETURN 0;
			END
		...
		BEGIN
			INSERT INTO @PrestamoItemEstudiante(Id) VALUES(0)
		...
		IF NOT EXISTS(SELECT 1 FROM Items WHERE Rfid=@i_rfid AND Estado=1)
		BEGIN
			INSERT INTO @PrestamoItemEstudiante(Id) VALUES(-1)
			SELECT TOP(1) * FROM @PrestamoItemEstudiante
			RETURN 0;
		END
		...
		IF((SELECT EstadoItemId FROM Items WHERE Rfid=@i_rfid AND Estado=1)=2)
		BEGIN
			INSERT INTO @PrestamoItemEstudiante(Id) VALUES(-2)
			SELECT TOP(1) * FROM @PrestamoItemEstudiante
			RETURN 0;
		END
	...
	BEGIN
		...
		IF NOT EXISTS(SELECT 1 FROM RegistroPrestamoItem WHERE Id=@i_id AND Estado=1)
		BEGIN
			INSERT INTO @PrestamoItemClase(Id) VALUES(0)
			SELECT TOP(1) * FROM @PrestamoItemClase
			RETURN 0;
		END
		...
		IF EXISTS(SELECT 1 FROM RegistroPrestamoItem r 
			...
			WHERE r.Id=@i_id AND (ed.Id=2 OR ed.Id=4) AND r.Estado=1)
		BEGIN
			INSERT INTO @PrestamoItemClase(Id) VALUES(-1)
			SELECT TOP(1) * FROM @PrestamoItemClase
			RETURN 0;
		END
		...
		BEGIN
			INSERT INTO @PrestamoItemClase(Id) VALUES(-2)
			SELECT TOP(1) * FROM @PrestamoItemClase
			RETURN 0;
		END
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_registroasistencia]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_usuario]    Script Date: 22/12/2022 21:25:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
