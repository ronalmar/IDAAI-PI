...
namespace IDAAI_API.Controllers
{
    ...
    public class CarreraController : ControllerBase
    {
            ...
            [FromQuery] CarreraNombreQuery query)
        {
            try
            {
                var result = await _context.Carreras
                    .FromSqlRaw($"EXEC sp_carrera @i_accion='CN', @i_nombre='{query.Nombre}', @i_modulo='{query.Modulo}'").ToListAsync();
            ...
            [FromQuery] CarreraModuloQuery query)
        {
            ...
            {
                var result = await _context.Carreras
                    .FromSqlRaw($"EXEC sp_carrera @i_accion='CL', @i_modulo='{query.Modulo}'").ToListAsync();
            ...
            [FromQuery] PaginacionQuery query)
        {
            ...
            {
                var result = await _context.Carreras
                    .FromSqlRaw($"EXEC sp_carrera @i_accion='CT'").ToListAsync();
            ...
            [FromBody] RegistrarCarreraRequest request)
        {
            ...
            {
                var result = await _context.Carreras
                    .FromSqlRaw($"EXEC sp_carrera @i_accion='IN', @i_nombre='{request.Nombre}', @i_modulo='{request.Modulo}'").ToListAsync();
            ...
            [FromBody] EditarCarreraRequest request)
        {
            ...
            {
                var result = await _context.Carreras
                    .FromSqlRaw($"EXEC sp_carrera @i_accion='UP', @i_nombre='{request.Nombre}', @i_modulo='{request.Modulo}', @i_id='{request.Id}'").ToListAsync();
